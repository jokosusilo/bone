...
@section('content')
<form action="{{ route('cp.social-media.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" id="link" class="form-control{{ $errors->has('link') ? ' is-invalid' : '' }}" name="link" autofocus="" value="{{ old('link') }}" placeholder="https://twitter.com/weldon_wallpaint">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                                <input type="text" id="icon" class="form-control{{ $errors->has('icon') ? ' is-invalid' : '' }}" name="icon" autofocus="" value="{{ old('icon') }}" placeholder="fab fa-facebook">
